...
> [`wp-graphql/wp-graphql`](https://github.com/wp-graphql/wp-graphql) at commit
> `b216fe22f3a119f256511ec7353f536fee6886ac` (2026-02-20), redistributed under that
...
> to on 2026-02-20; see `pinning.md` in the harness output for
